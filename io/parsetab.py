...
_lr_productions = [
  ...
  ('if_statement -> SE conditional_expression PONTO ENTAO PONTO block SENAO PONTO block','if_statement',9,'p_if_statement','yacc.py',156),
